...
const Navbar = ({ cartCount }) => {
  ...
  const handleLoginRedirect = (e) => {
    ...
    toggleLoginDropdown(); // Show the dropdown after login redirection
  };
    ...
    <>
      <nav className="navbar navbar-expand-lg navbar-dark">
        <div className="container">
          <Link className="navbar-brand" to="/">KrazeCart</Link>
          <button
                ...
                <li className="nav-item dropdown">
                  ...
                  {isLoginDropdownOpen && (
                    <ul className="dropdown-menu show">
                      ...
                      <li><Link className="dropdown-item" to="/my-reviews-and-ratings">My Reviews & Ratings</Link></li>              
                      <li><hr className="dropdown-divider" /></li>
                      <li><Link className="dropdown-item" to="#" onClick={handleLoginRedirect}>Logout</Link></li>
                    </ul>
                  )}
                </li>
              )}
